...
const palavrasOriginais: Palavra[] = [
    { palavra: "amarelo", imagem: "amarelo.png" },
    { palavra: "vermelho", imagem: "vermelho.png" },
    { palavra: "azul", imagem: "azul.png" },
    { palavra: "verde", imagem: "verde.png" },
    { palavra: "rosa", imagem: "rosa.png" },
    { palavra: "branco", imagem: "branco.png" },
    { palavra: "preto", imagem: "preto.png" },
    { palavra: "casa", imagem: "casa.png" },
    { palavra: "carro", imagem: "carro.png" },
    { palavra: "bola", imagem: "bola.png" },
    { palavra: "mamãe", imagem: "mamãe.png" },
    { palavra: "papai", imagem: "papai.png" },
    { palavra: "gato", imagem: "gato.png" },
    { palavra: "cachorro", imagem: "cachorro.png" },
    { palavra: "peixe", imagem: "peixe.png" },
    { palavra: "pato", imagem: "pato.png" },
    { palavra: "macaco", imagem: "macaco.png" },
    { palavra: "elefante", imagem: "elefante.png" },
    { palavra: "girafa", imagem: "girafa.png" },
    { palavra: "leão", imagem: "leão.png" },
    { palavra: "tigre", imagem: "tigre.png" },
    { palavra: "urso", imagem: "urso.png" },
    { palavra: "sol", imagem: "sol.png" },
    { palavra: "lua", imagem: "lua.png" },
    { palavra: "flor", imagem: "flor.png" },
    { palavra: "montanha-russa", imagem: "montanha-russa.png" },
    { palavra: "carrossel", imagem: "carrossel.png" },
    { palavra: "roda-gigante", imagem: "roda-gigante.png" }
];
...
const getImageUrl = (name: string) => {
    return new URL(`../../assets/images/soletrando/${name}`, import.meta.url).href;
};
            ...
            {!started && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl shadow-xl text-center max-w-sm w-full mx-4">
                        <p className="text-2xl font-bold mb-6 text-gray-800">Jogo de Soletrar</p>
                        <button
                            onClick={iniciarJogo}
                            className="bg-green-500 hover:bg-green-600 text-white text-xl font-bold py-3 px-8 rounded-lg shadow cursor-pointer transition transform hover:scale-105 w-full"
                        >
                            Iniciar
                        </button>
                    </div>
